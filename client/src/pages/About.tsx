          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-[#64748B] leading-relaxed mb-6"
                style={{ fontFamily: "'DM Sans', sans-serif" }}>
                Founded in 2014, Aicen Solutions has grown from a small ERP consultancy to a leading Microsoft Partner with over 50 certified professionals serving clients across multiple industries and regions.
              </p>
